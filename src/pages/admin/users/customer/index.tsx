              ...
              >
                <Tab.List className="flex flex-col xl2:flex-row justify-between px-2 py-4 border-b gap-4 border-gray-200 overflow-auto">
                  <div className="flex flex-col items-start justify-center">
                    <h2 className="pr-4 pb-2">مشتری</h2>
                        ...
                        <table className="w-[700px] md:w-full mx-auto">
                          <thead className="bg-sky-300">
                            <tr>
                              ...
                              <th className="text-sm py-3 px-2 text-gray-600 font-normal w-[18%]">آخرین فعالیت </th>
                              <th className="text-sm py-3 px-2 text-gray-600 font-normal">سفارش ها </th>
                              <th className="text-sm py-3 px-2 text-gray-600 font-normal">شهر</th>
                              <th className="text-sm py-3 px-2 text-gray-600 font-normal">کیف پول </th>
                              ...
                              usersPagination?.data?.data.map((user, index) => {
                                return (
                                  <tr key={user.id} className={`h-16 border-b ${index % 2 === 0 ? 'bg-gray-50' : ''}`}>
                                    ...
                                    <td className="text-center">
                                      <div className="text-sm px-2">{user.fullName === ' ' ? '-' : user.fullName}</div>
                                    </td>
                                        ...
                                        {user.lastActivity ? (
                                          <>
                                            <span className="font-medium">
                                              {moment(user.lastActivity).format('jYYYY/jMM/jDD')}
                                            </span>
                                            <span className="text-gray-500 mx-1">|</span>
                                            <span className="font-medium">
                                              {moment(user.lastActivity).format('HH:mm')}
                                            </span>
                                          </>
                                        ) : (
                                    ...
                                    <td className="text-center">
                                      <div className="text-sm px-2">
                                        {user.orderCount === 0 ? '-' : digitsEnToFa(user.orderCount)}
                                      </div>
                                    </td>

                                    <td className="text-center">
                                      <div className="text-sm px-2">{user.city}</div>
                                    </td>

                                    <td className="text-center">
                                      <div className="text-sm px-2">{user.wallet ? '' : '-'}</div>
                                    </td>

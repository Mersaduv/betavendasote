...
import { useCreateSmsMessageMutation, useGetRolesQuery } from '@/services'
...
const NewSms: NextPage<Props> = () => {
  ...
  // ? Create
  // ? Create Sms
  const [createSms, { isSuccess, isLoading, data, isError, error }] = useCreateSmsMessageMutation()
  // ? Handlers
  const onSuccess = () => {
...
export default dynamic(() => Promise.resolve(NewSms), { ssr: false })

...
import { INotificationForm, IProductForm, ITicketAdminForm } from '@/types'
import {
...
import { notificationFormValidationSchema, ticketAdminFormValidationSchema } from '@/utils'
...
const NewNotification: NextPage<Props> = () => {
  // ? Assets
  ...
  const {
    ...
    resolver: yupResolver(notificationFormValidationSchema({ sendingTime })) as unknown as Resolver<INotificationForm>,
    context: { sendingTime },
  })
  // ? Create
  // ? Create Notification
  const [createNotification, { isSuccess, isLoading, data, isError, error }] = useCreateNotificationMutation()
  // ? Handlers
  const onSuccess = () => {
...
export default dynamic(() => Promise.resolve(NewNotification), { ssr: false })

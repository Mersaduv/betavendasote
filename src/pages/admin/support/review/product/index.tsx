...
import { useDeleteReviewMutation, useGetReviewsQuery, useGetTicketsQuery } from '@/services'
import { useRouter } from 'next/router'
import { IReview, ITicket, UserTypes } from '@/types'
...
import { ConfirmDeleteModal, ReviewEditModal } from '@/components/modals'
const Review: NextPage = () => {
  ...
  const [reviewState, setReviewState] = useState<IReview | null>(null)
  ...
  // ? tickets Query
  const [reviewsPagination, setReviewsPagination] = useState<GetReviewsResultPagination<IReview[]>>()
  const [reviewsAwaitingPagination, setReviewsAwaitingPagination] = useState<GetReviewsResultPagination<IReview[]>>()
  const [reviewsApprovalPagination, setReviewsApprovalPagination] = useState<GetReviewsResultPagination<IReview[]>>()
  const [reviewsRejectedPagination, setReviewsRejectedPagination] = useState<GetReviewsResultPagination<IReview[]>>()

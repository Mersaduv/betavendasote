            ...
            >
              ...
              <div className=" flex flex-col items-center justify-center">
                <input
                  type="file"
                  className="hidden"
                  id={`thumbnailProductSize-${mode}`}
                  onChange={handleMainFileChange}
                />
                <label
                  htmlFor={`thumbnailProductSize-${mode}`}
              ...
              <div className="flex px-5 py-3 justify-between items-center gap-x-20 bg-[#f5f8fa]">
                ...
                <Button type="submit" className="bg-sky-500 px-5 py-3 hover:bg-sky-600" isLoading={isLoadingUpdate}>
                  بروزرسانی
                </Button>
              </div>
            </form>

...
interface ReviewTabDashboardLayoutProps {
  children: ReactNode
}
...
const ReviewTabDashboardLayout: React.FC<ReviewTabDashboardLayoutProps> = ({ children }) => {
...
export default ReviewTabDashboardLayout;
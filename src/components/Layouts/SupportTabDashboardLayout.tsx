...
interface SupportTabDashboardLayoutProps {
  children: ReactNode
}

const tabs = [
  { paths: ['/admin/support/messages/ticket'], label: 'تیکت' },
  { paths: ['/admin/support/messages/notifications'], label: 'اعلانات' },
  { paths: ['/admin/support/messages/sms-list'], label: 'پیامک' },
]


const SupportTabDashboardLayout: React.FC<SupportTabDashboardLayoutProps> = ({ children }) => {
...
export default SupportTabDashboardLayout;